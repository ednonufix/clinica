...
public class TGraficos {
    ...
    ImageView cerrar = new ImageView("/resources/process-stop.png");
    ImageView nuevo = new ImageView("/resources/document-new.png");
    ImageView add = new ImageView("/resources/add.png");
    ImageView del = new ImageView("/resources/remove.png");
    Image icon = new Image("/resources/presentacion2.png");
